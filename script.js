...
‎
‎        // Mark branch as unlocked
‎        unlockedBranches[branch] = true;
‎
‎        // Sync the reward bar immediately to current dashboard progress
‎        updateRewardsProgress();
‎
‎        // Update the dashboard bar in real-time
‎        updateDashboardProgress();
‎    }
‎}
‎
‎// ------------------- DASHBOARD LOGICAL WING PROGRESS (AUTO-FILL 12H) -------------------
...
‎
‎        // Reset every 12 hours for fairness
...
‎
‎        // Add unlocked branch contribution
...
‎
‎        // Smoothly animate dashboard fill
‎        animateProgress(progressFill, totalProgress);
‎    }
‎
‎    // Update dashboard bar every second
‎    setInterval(updateDashboardProgress, 1000);
‎}
‎
‎// ------------------- REWARDS PAGE PROGRESS / SYNC -------------------
...
‎    const step = 0.5; // smaller = smoother
‎
‎    function fillStep() {
...
‎}
‎
‎// Update all reward bars based on dashboard bar
